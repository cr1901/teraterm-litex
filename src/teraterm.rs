...
pub type LogTimestampType = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct eterm_lookfeel_t {
    ...
    pub reserver_BGThemeFile: [::std::os::raw::c_char; 244usize],
    pub BGThemeFileW: *mut wchar_t,
    pub BGSPIPathW: *mut wchar_t,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of eterm_lookfeel_t"][::std::mem::size_of::<eterm_lookfeel_t>() - 544usize];
    ["Alignment of eterm_lookfeel_t"][::std::mem::align_of::<eterm_lookfeel_t>() - 8usize];
    ...
    ["Offset of field: eterm_lookfeel_t::BGThemeFileW"]
        [::std::mem::offset_of!(eterm_lookfeel_t, BGThemeFileW) - 528usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of tttset"][::std::mem::size_of::<tttset>() - 10464usize];
    ["Alignment of tttset"][::std::mem::align_of::<tttset>() - 8usize];
    ...
    ["Offset of field: tttset::reserve_TmpColor"]
        [::std::mem::offset_of!(tttset, reserve_TmpColor) - 3184usize];
    ["Offset of field: tttset::Title"][::std::mem::offset_of!(tttset, Title) - 3328usize];
    ["Offset of field: tttset::TitleFormat"]
        [::std::mem::offset_of!(tttset, TitleFormat) - 3378usize];
    ["Offset of field: tttset::CursorShape"]
        [::std::mem::offset_of!(tttset, CursorShape) - 3380usize];
    ["Offset of field: tttset::NonblinkingCursor"]
        [::std::mem::offset_of!(tttset, NonblinkingCursor) - 3382usize];
    ["Offset of field: tttset::EnableScrollBuff"]
        [::std::mem::offset_of!(tttset, EnableScrollBuff) - 3384usize];
    ["Offset of field: tttset::ScrollBuffSize"]
        [::std::mem::offset_of!(tttset, ScrollBuffSize) - 3388usize];
    ["Offset of field: tttset::ScrollBuffMax"]
        [::std::mem::offset_of!(tttset, ScrollBuffMax) - 3392usize];
    ["Offset of field: tttset::HideTitle"][::std::mem::offset_of!(tttset, HideTitle) - 3396usize];
    ["Offset of field: tttset::PopupMenu"][::std::mem::offset_of!(tttset, PopupMenu) - 3398usize];
    ["Offset of field: tttset::ColorFlag"][::std::mem::offset_of!(tttset, ColorFlag) - 3400usize];
    ["Offset of field: tttset::TEKColorEmu"]
        [::std::mem::offset_of!(tttset, TEKColorEmu) - 3404usize];
    ["Offset of field: tttset::VTColor"][::std::mem::offset_of!(tttset, VTColor) - 3408usize];
    ["Offset of field: tttset::TEKColor"][::std::mem::offset_of!(tttset, TEKColor) - 3416usize];
    ["Offset of field: tttset::URLColor"][::std::mem::offset_of!(tttset, URLColor) - 3424usize];
    ["Offset of field: tttset::VTBoldColor"]
        [::std::mem::offset_of!(tttset, VTBoldColor) - 3432usize];
    ["Offset of field: tttset::VTFaintColor"]
        [::std::mem::offset_of!(tttset, VTFaintColor) - 3440usize];
    ["Offset of field: tttset::VTItalicColor"]
        [::std::mem::offset_of!(tttset, VTItalicColor) - 3448usize];
    ["Offset of field: tttset::VTUnderlineColor"]
        [::std::mem::offset_of!(tttset, VTUnderlineColor) - 3456usize];
    ["Offset of field: tttset::VTBlinkColor"]
        [::std::mem::offset_of!(tttset, VTBlinkColor) - 3464usize];
    ["Offset of field: tttset::VTRapidBlinkColor"]
        [::std::mem::offset_of!(tttset, VTRapidBlinkColor) - 3472usize];
    ["Offset of field: tttset::VTReverseColor"]
        [::std::mem::offset_of!(tttset, VTReverseColor) - 3480usize];
    ["Offset of field: tttset::VTInvisibleColor"]
        [::std::mem::offset_of!(tttset, VTInvisibleColor) - 3488usize];
    ["Offset of field: tttset::VTStrikeoutColor"]
        [::std::mem::offset_of!(tttset, VTStrikeoutColor) - 3496usize];
    ["Offset of field: tttset::DummyColor"][::std::mem::offset_of!(tttset, DummyColor) - 3504usize];
    ["Offset of field: tttset::Beep"][::std::mem::offset_of!(tttset, Beep) - 3512usize];
    ["Offset of field: tttset::BSKey"][::std::mem::offset_of!(tttset, BSKey) - 3514usize];
    ["Offset of field: tttset::DelKey"][::std::mem::offset_of!(tttset, DelKey) - 3516usize];
    ["Offset of field: tttset::UseIME"][::std::mem::offset_of!(tttset, UseIME) - 3518usize];
    ["Offset of field: tttset::IMEInline"][::std::mem::offset_of!(tttset, IMEInline) - 3520usize];
    ["Offset of field: tttset::MetaKey"][::std::mem::offset_of!(tttset, MetaKey) - 3522usize];
    ["Offset of field: tttset::RussKeyb"][::std::mem::offset_of!(tttset, RussKeyb) - 3524usize];
    ["Offset of field: tttset::PortType"][::std::mem::offset_of!(tttset, PortType) - 3526usize];
    ["Offset of field: tttset::TCPPort"][::std::mem::offset_of!(tttset, TCPPort) - 3528usize];
    ["Offset of field: tttset::Telnet"][::std::mem::offset_of!(tttset, Telnet) - 3530usize];
    ["Offset of field: tttset::TelPort"][::std::mem::offset_of!(tttset, TelPort) - 3532usize];
    ["Offset of field: tttset::TelBin"][::std::mem::offset_of!(tttset, TelBin) - 3534usize];
    ["Offset of field: tttset::TelEcho"][::std::mem::offset_of!(tttset, TelEcho) - 3536usize];
    ["Offset of field: tttset::TermType"][::std::mem::offset_of!(tttset, TermType) - 3538usize];
    ["Offset of field: tttset::AutoWinClose"]
        [::std::mem::offset_of!(tttset, AutoWinClose) - 3578usize];
    ["Offset of field: tttset::PortFlag"][::std::mem::offset_of!(tttset, PortFlag) - 3580usize];
    ["Offset of field: tttset::TCPCRSend"][::std::mem::offset_of!(tttset, TCPCRSend) - 3582usize];
    ["Offset of field: tttset::TCPLocalEcho"]
        [::std::mem::offset_of!(tttset, TCPLocalEcho) - 3584usize];
    ["Offset of field: tttset::HistoryList"]
        [::std::mem::offset_of!(tttset, HistoryList) - 3586usize];
    ["Offset of field: tttset::ComPort"][::std::mem::offset_of!(tttset, ComPort) - 3588usize];
    ["Offset of field: tttset::Baud_"][::std::mem::offset_of!(tttset, Baud_) - 3590usize];
    ["Offset of field: tttset::Parity"][::std::mem::offset_of!(tttset, Parity) - 3592usize];
    ["Offset of field: tttset::DataBit"][::std::mem::offset_of!(tttset, DataBit) - 3594usize];
    ["Offset of field: tttset::StopBit"][::std::mem::offset_of!(tttset, StopBit) - 3596usize];
    ["Offset of field: tttset::Flow"][::std::mem::offset_of!(tttset, Flow) - 3598usize];
    ["Offset of field: tttset::DelayPerChar"]
        [::std::mem::offset_of!(tttset, DelayPerChar) - 3600usize];
    ["Offset of field: tttset::DelayPerLine"]
        [::std::mem::offset_of!(tttset, DelayPerLine) - 3602usize];
    ["Offset of field: tttset::MaxComPort"][::std::mem::offset_of!(tttset, MaxComPort) - 3604usize];
    ["Offset of field: tttset::ComAutoConnect"]
        [::std::mem::offset_of!(tttset, ComAutoConnect) - 3606usize];
    ["Offset of field: tttset::EnableContinuedLineCopy"]
        [::std::mem::offset_of!(tttset, EnableContinuedLineCopy) - 3608usize];
    ["Offset of field: tttset::ANSIColor"][::std::mem::offset_of!(tttset, ANSIColor) - 3612usize];
    ["Offset of field: tttset::ProtocolFamily"]
        [::std::mem::offset_of!(tttset, ProtocolFamily) - 3676usize];
    ["Offset of field: tttset::MouseCursorName"]
        [::std::mem::offset_of!(tttset, MouseCursorName) - 3680usize];
    ["Offset of field: tttset::AlphaBlendActive"]
        [::std::mem::offset_of!(tttset, AlphaBlendActive) - 3696usize];
    ["Offset of field: tttset::AlphaBlendInactive"]
        [::std::mem::offset_of!(tttset, AlphaBlendInactive) - 3697usize];
    ["Offset of field: tttset::reserve_0"][::std::mem::offset_of!(tttset, reserve_0) - 3698usize];
    ["Offset of field: tttset::CygwinDirectory"]
        [::std::mem::offset_of!(tttset, CygwinDirectory) - 3700usize];
    ["Offset of field: tttset::reserve_Locale"]
        [::std::mem::offset_of!(tttset, reserve_Locale) - 3960usize];
    ["Offset of field: tttset::reserve_CodePage"]
        [::std::mem::offset_of!(tttset, reserve_CodePage) - 4040usize];
    ["Offset of field: tttset::DuplicateSession"]
        [::std::mem::offset_of!(tttset, DuplicateSession) - 4044usize];
    ["Offset of field: tttset::reserve_ViewlogEditor"]
        [::std::mem::offset_of!(tttset, reserve_ViewlogEditor) - 4048usize];
    ["Offset of field: tttset::LogTypePlainText"]
        [::std::mem::offset_of!(tttset, LogTypePlainText) - 4308usize];
    ["Offset of field: tttset::LogTimestamp"]
        [::std::mem::offset_of!(tttset, LogTimestamp) - 4310usize];
    ["Offset of field: tttset::reserve_LogDefaultName"]
        [::std::mem::offset_of!(tttset, reserve_LogDefaultName) - 4312usize];
    ["Offset of field: tttset::reserve_LogDefaultPath"]
        [::std::mem::offset_of!(tttset, reserve_LogDefaultPath) - 4392usize];
    ["Offset of field: tttset::LogAutoStart"]
        [::std::mem::offset_of!(tttset, LogAutoStart) - 4652usize];
    ["Offset of field: tttset::PasteFlag"][::std::mem::offset_of!(tttset, PasteFlag) - 4656usize];
    ["Offset of field: tttset::FallbackToCP932"]
        [::std::mem::offset_of!(tttset, FallbackToCP932) - 4660usize];
    ["Offset of field: tttset::DisableAcceleratorSendBreak"]
        [::std::mem::offset_of!(tttset, DisableAcceleratorSendBreak) - 4662usize];
    ["Offset of field: tttset::EnableClickableUrl"]
        [::std::mem::offset_of!(tttset, EnableClickableUrl) - 4664usize];
    ["Offset of field: tttset::EtermLookfeel"]
        [::std::mem::offset_of!(tttset, EtermLookfeel) - 4672usize];
    ["Offset of field: tttset::UseNormalBGColor"]
        [::std::mem::offset_of!(tttset, UseNormalBGColor) - 5216usize];
    ["Offset of field: tttset::reserve_UILanguageFile"]
        [::std::mem::offset_of!(tttset, reserve_UILanguageFile) - 5218usize];
    ["Offset of field: tttset::reserve_UIMsg"]
        [::std::mem::offset_of!(tttset, reserve_UIMsg) - 5478usize];
    ["Offset of field: tttset::BroadcastCommandHistory"]
        [::std::mem::offset_of!(tttset, BroadcastCommandHistory) - 6502usize];
    ["Offset of field: tttset::AcceptBroadcast"]
        [::std::mem::offset_of!(tttset, AcceptBroadcast) - 6504usize];
    ["Offset of field: tttset::DisableTCPEchoCR"]
        [::std::mem::offset_of!(tttset, DisableTCPEchoCR) - 6506usize];
    ["Offset of field: tttset::ConnectingTimeout"]
        [::std::mem::offset_of!(tttset, ConnectingTimeout) - 6508usize];
    ["Offset of field: tttset::VTCompatTab"]
        [::std::mem::offset_of!(tttset, VTCompatTab) - 6512usize];
    ["Offset of field: tttset::TelKeepAliveInterval"]
        [::std::mem::offset_of!(tttset, TelKeepAliveInterval) - 6514usize];
    ["Offset of field: tttset::MaxBroadcatHistory"]
        [::std::mem::offset_of!(tttset, MaxBroadcatHistory) - 6516usize];
    ["Offset of field: tttset::DisableAppKeypad"]
        [::std::mem::offset_of!(tttset, DisableAppKeypad) - 6518usize];
    ["Offset of field: tttset::DisableAppCursor"]
        [::std::mem::offset_of!(tttset, DisableAppCursor) - 6520usize];
    ["Offset of field: tttset::ClearComBuffOnOpen"]
        [::std::mem::offset_of!(tttset, ClearComBuffOnOpen) - 6522usize];
    ["Offset of field: tttset::Send8BitCtrl"]
        [::std::mem::offset_of!(tttset, Send8BitCtrl) - 6524usize];
    ["Offset of field: tttset::reserve_UILanguageFile_ini"]
        [::std::mem::offset_of!(tttset, reserve_UILanguageFile_ini) - 6526usize];
    ["Offset of field: tttset::SelectOnlyByLButton"]
        [::std::mem::offset_of!(tttset, SelectOnlyByLButton) - 6786usize];
    ["Offset of field: tttset::TelAutoDetect"]
        [::std::mem::offset_of!(tttset, TelAutoDetect) - 6788usize];
    ["Offset of field: tttset::XModemRcvCommand"]
        [::std::mem::offset_of!(tttset, XModemRcvCommand) - 6790usize];
    ["Offset of field: tttset::ZModemRcvCommand"]
        [::std::mem::offset_of!(tttset, ZModemRcvCommand) - 7050usize];
    ["Offset of field: tttset::ConfirmFileDragAndDrop"]
        [::std::mem::offset_of!(tttset, ConfirmFileDragAndDrop) - 7310usize];
    ["Offset of field: tttset::TranslateWheelToCursor"]
        [::std::mem::offset_of!(tttset, TranslateWheelToCursor) - 7312usize];
    ["Offset of field: tttset::HostDialogOnStartup"]
        [::std::mem::offset_of!(tttset, HostDialogOnStartup) - 7314usize];
    ["Offset of field: tttset::MouseEventTracking"]
        [::std::mem::offset_of!(tttset, MouseEventTracking) - 7316usize];
    ["Offset of field: tttset::KillFocusCursor"]
        [::std::mem::offset_of!(tttset, KillFocusCursor) - 7318usize];
    ["Offset of field: tttset::LogHideDialog"]
        [::std::mem::offset_of!(tttset, LogHideDialog) - 7320usize];
    ["Offset of field: tttset::FTHideDialog"]
        [::std::mem::offset_of!(tttset, FTHideDialog) - 7322usize];
    ["Offset of field: tttset::TerminalOldWidth"]
        [::std::mem::offset_of!(tttset, TerminalOldWidth) - 7324usize];
    ["Offset of field: tttset::TerminalOldHeight"]
        [::std::mem::offset_of!(tttset, TerminalOldHeight) - 7328usize];
    ["Offset of field: tttset::MaximizedBugTweak"]
        [::std::mem::offset_of!(tttset, MaximizedBugTweak) - 7332usize];
    ["Offset of field: tttset::NotifyClipboardAccess"]
        [::std::mem::offset_of!(tttset, NotifyClipboardAccess) - 7334usize];
    ["Offset of field: tttset::SaveVTWinPos"]
        [::std::mem::offset_of!(tttset, SaveVTWinPos) - 7336usize];
    ["Offset of field: tttset::LogTimestampType"]
        [::std::mem::offset_of!(tttset, LogTimestampType) - 7338usize];
    ["Offset of field: tttset::MouseWheelScrollLine"]
        [::std::mem::offset_of!(tttset, MouseWheelScrollLine) - 7340usize];
    ["Offset of field: tttset::CRSend_ini"][::std::mem::offset_of!(tttset, CRSend_ini) - 7344usize];
    ["Offset of field: tttset::LocalEcho_ini"]
        [::std::mem::offset_of!(tttset, LocalEcho_ini) - 7346usize];
    ["Offset of field: tttset::UnicodeDecSpMapping"]
        [::std::mem::offset_of!(tttset, UnicodeDecSpMapping) - 7348usize];
    ["Offset of field: tttset::VTIcon"][::std::mem::offset_of!(tttset, VTIcon) - 7350usize];
    ["Offset of field: tttset::TEKIcon"][::std::mem::offset_of!(tttset, TEKIcon) - 7352usize];
    ["Offset of field: tttset::ScrollWindowClearScreen"]
        [::std::mem::offset_of!(tttset, ScrollWindowClearScreen) - 7354usize];
    ["Offset of field: tttset::AutoScrollOnlyInBottomLine"]
        [::std::mem::offset_of!(tttset, AutoScrollOnlyInBottomLine) - 7356usize];
    ["Offset of field: tttset::reserve_UnknownUnicodeCharaAsWide"]
        [::std::mem::offset_of!(tttset, reserve_UnknownUnicodeCharaAsWide) - 7358usize];
    ["Offset of field: tttset::YModemRcvCommand"]
        [::std::mem::offset_of!(tttset, YModemRcvCommand) - 7360usize];
    ["Offset of field: tttset::AcceptTitleChangeRequest"]
        [::std::mem::offset_of!(tttset, AcceptTitleChangeRequest) - 7620usize];
    ["Offset of field: tttset::PasteDialogSize"]
        [::std::mem::offset_of!(tttset, PasteDialogSize) - 7624usize];
    ["Offset of field: tttset::DisableMouseTrackingByCtrl"]
        [::std::mem::offset_of!(tttset, DisableMouseTrackingByCtrl) - 7632usize];
    ["Offset of field: tttset::DisableWheelToCursorByCtrl"]
        [::std::mem::offset_of!(tttset, DisableWheelToCursorByCtrl) - 7634usize];
    ["Offset of field: tttset::StrictKeyMapping"]
        [::std::mem::offset_of!(tttset, StrictKeyMapping) - 7636usize];
    ["Offset of field: tttset::Wait4allMacroCommand"]
        [::std::mem::offset_of!(tttset, Wait4allMacroCommand) - 7638usize];
    ["Offset of field: tttset::DisableMenuSendBreak"]
        [::std::mem::offset_of!(tttset, DisableMenuSendBreak) - 7640usize];
    ["Offset of field: tttset::ClearScreenOnCloseConnection"]
        [::std::mem::offset_of!(tttset, ClearScreenOnCloseConnection) - 7642usize];
    ["Offset of field: tttset::DisableAcceleratorDuplicateSession"]
        [::std::mem::offset_of!(tttset, DisableAcceleratorDuplicateSession) - 7644usize];
    ["Offset of field: tttset::PasteDelayPerLine"]
        [::std::mem::offset_of!(tttset, PasteDelayPerLine) - 7648usize];
    ["Offset of field: tttset::FontScaling"]
        [::std::mem::offset_of!(tttset, FontScaling) - 7652usize];
    ["Offset of field: tttset::Meta8Bit"][::std::mem::offset_of!(tttset, Meta8Bit) - 7654usize];
    ["Offset of field: tttset::WindowFlag"][::std::mem::offset_of!(tttset, WindowFlag) - 7656usize];
    ["Offset of field: tttset::EnableLineMode"]
        [::std::mem::offset_of!(tttset, EnableLineMode) - 7658usize];
    ["Offset of field: tttset::ConfirmChangePasteStringFile"]
        [::std::mem::offset_of!(tttset, ConfirmChangePasteStringFile) - 7660usize];
    ["Offset of field: tttset::Baud"][::std::mem::offset_of!(tttset, Baud) - 7920usize];
    ["Offset of field: tttset::LogBinary"][::std::mem::offset_of!(tttset, LogBinary) - 7924usize];
    ["Offset of field: tttset::DisableMenuDuplicateSession"]
        [::std::mem::offset_of!(tttset, DisableMenuDuplicateSession) - 7926usize];
    ["Offset of field: tttset::DisableMenuNewConnection"]
        [::std::mem::offset_of!(tttset, DisableMenuNewConnection) - 7928usize];
    ["Offset of field: tttset::TerminalUID"]
        [::std::mem::offset_of!(tttset, TerminalUID) - 7930usize];
    ["Offset of field: tttset::ISO2022Flag"]
        [::std::mem::offset_of!(tttset, ISO2022Flag) - 7940usize];
    ["Offset of field: tttset::JumpList"][::std::mem::offset_of!(tttset, JumpList) - 7942usize];
    ["Offset of field: tttset::TabStopFlag"]
        [::std::mem::offset_of!(tttset, TabStopFlag) - 7944usize];
    ["Offset of field: tttset::CtrlFlag"][::std::mem::offset_of!(tttset, CtrlFlag) - 7948usize];
    ["Offset of field: tttset::ClickableUrlBrowser"]
        [::std::mem::offset_of!(tttset, ClickableUrlBrowser) - 7952usize];
    ["Offset of field: tttset::ClickableUrlBrowserArg"]
        [::std::mem::offset_of!(tttset, ClickableUrlBrowserArg) - 8212usize];
    ["Offset of field: tttset::LogLockExclusive"]
        [::std::mem::offset_of!(tttset, LogLockExclusive) - 8472usize];
    ["Offset of field: tttset::KermitOpt"][::std::mem::offset_of!(tttset, KermitOpt) - 8474usize];
    ["Offset of field: tttset::FontQuality"]
        [::std::mem::offset_of!(tttset, FontQuality) - 8476usize];
    ["Offset of field: tttset::ScpSendDir"][::std::mem::offset_of!(tttset, ScpSendDir) - 8478usize];
    ["Offset of field: tttset::reserver_BGImageFilePath"]
        [::std::mem::offset_of!(tttset, reserver_BGImageFilePath) - 8734usize];
    ["Offset of field: tttset::LogRotate"][::std::mem::offset_of!(tttset, LogRotate) - 8996usize];
    ["Offset of field: tttset::LogRotateSize"]
        [::std::mem::offset_of!(tttset, LogRotateSize) - 9000usize];
    ["Offset of field: tttset::LogRotateSizeType"]
        [::std::mem::offset_of!(tttset, LogRotateSizeType) - 9004usize];
    ["Offset of field: tttset::LogRotateStep"]
        [::std::mem::offset_of!(tttset, LogRotateStep) - 9006usize];
    ["Offset of field: tttset::DeferredLogWriteMode"]
        [::std::mem::offset_of!(tttset, DeferredLogWriteMode) - 9008usize];
    ["Offset of field: tttset::BeepOverUsedCount"]
        [::std::mem::offset_of!(tttset, BeepOverUsedCount) - 9012usize];
    ["Offset of field: tttset::BeepOverUsedTime"]
        [::std::mem::offset_of!(tttset, BeepOverUsedTime) - 9016usize];
    ["Offset of field: tttset::BeepSuppressTime"]
        [::std::mem::offset_of!(tttset, BeepSuppressTime) - 9020usize];
    ["Offset of field: tttset::LogAllBuffIncludedInFirst"]
        [::std::mem::offset_of!(tttset, LogAllBuffIncludedInFirst) - 9024usize];
    ["Offset of field: tttset::MaxOSCBufferSize"]
        [::std::mem::offset_of!(tttset, MaxOSCBufferSize) - 9028usize];
    ["Offset of field: tttset::JoinSplitURL"]
        [::std::mem::offset_of!(tttset, JoinSplitURL) - 9032usize];
    ["Offset of field: tttset::JoinSplitURLIgnoreEOLChar"]
        [::std::mem::offset_of!(tttset, JoinSplitURLIgnoreEOLChar) - 9034usize];
    ["Offset of field: tttset::MulticastName"]
        [::std::mem::offset_of!(tttset, MulticastName) - 9035usize];
    ["Offset of field: tttset::DebugModes"][::std::mem::offset_of!(tttset, DebugModes) - 9296usize];
    ["Offset of field: tttset::AcceleratorNewConnection"]
        [::std::mem::offset_of!(tttset, AcceleratorNewConnection) - 9298usize];
    ["Offset of field: tttset::AcceleratorCygwinConnection"]
        [::std::mem::offset_of!(tttset, AcceleratorCygwinConnection) - 9300usize];
    ["Offset of field: tttset::SendBreakTime"]
        [::std::mem::offset_of!(tttset, SendBreakTime) - 9304usize];
    ["Offset of field: tttset::FileSendHighSpeedMode"]
        [::std::mem::offset_of!(tttset, FileSendHighSpeedMode) - 9308usize];
    ["Offset of field: tttset::AutoComPortReconnect"]
        [::std::mem::offset_of!(tttset, AutoComPortReconnect) - 9310usize];
    ["Offset of field: tttset::reserver_BGImgBrightness"]
        [::std::mem::offset_of!(tttset, reserver_BGImgBrightness) - 9312usize];
    ["Offset of field: tttset::reserve_CygtermSettings"]
        [::std::mem::offset_of!(tttset, reserve_CygtermSettings) - 9314usize];
    ["Offset of field: tttset::XmodemTimeOutInit"]
        [::std::mem::offset_of!(tttset, XmodemTimeOutInit) - 10036usize];
    ["Offset of field: tttset::XmodemTimeOutInitCRC"]
        [::std::mem::offset_of!(tttset, XmodemTimeOutInitCRC) - 10040usize];
    ["Offset of field: tttset::XmodemTimeOutShort"]
        [::std::mem::offset_of!(tttset, XmodemTimeOutShort) - 10044usize];
    ["Offset of field: tttset::XmodemTimeOutLong"]
        [::std::mem::offset_of!(tttset, XmodemTimeOutLong) - 10048usize];
    ["Offset of field: tttset::XmodemTimeOutVLong"]
        [::std::mem::offset_of!(tttset, XmodemTimeOutVLong) - 10052usize];
    ["Offset of field: tttset::YmodemTimeOutInit"]
        [::std::mem::offset_of!(tttset, YmodemTimeOutInit) - 10056usize];
    ["Offset of field: tttset::YmodemTimeOutInitCRC"]
        [::std::mem::offset_of!(tttset, YmodemTimeOutInitCRC) - 10060usize];
    ["Offset of field: tttset::YmodemTimeOutShort"]
        [::std::mem::offset_of!(tttset, YmodemTimeOutShort) - 10064usize];
    ["Offset of field: tttset::YmodemTimeOutLong"]
        [::std::mem::offset_of!(tttset, YmodemTimeOutLong) - 10068usize];
    ["Offset of field: tttset::YmodemTimeOutVLong"]
        [::std::mem::offset_of!(tttset, YmodemTimeOutVLong) - 10072usize];
    ["Offset of field: tttset::ZmodemTimeOutNormal"]
        [::std::mem::offset_of!(tttset, ZmodemTimeOutNormal) - 10076usize];
    ["Offset of field: tttset::ZmodemTimeOutTCPIP"]
        [::std::mem::offset_of!(tttset, ZmodemTimeOutTCPIP) - 10080usize];
    ["Offset of field: tttset::ZmodemTimeOutInit"]
        [::std::mem::offset_of!(tttset, ZmodemTimeOutInit) - 10084usize];
    ["Offset of field: tttset::ZmodemTimeOutFin"]
        [::std::mem::offset_of!(tttset, ZmodemTimeOutFin) - 10088usize];
    ["Offset of field: tttset::WaitCom"][::std::mem::offset_of!(tttset, WaitCom) - 10092usize];
    ["Offset of field: tttset::ListHiddenFonts"]
        [::std::mem::offset_of!(tttset, ListHiddenFonts) - 10094usize];
    ["Offset of field: tttset::LogTimestampFormat"]
        [::std::mem::offset_of!(tttset, LogTimestampFormat) - 10096usize];
    ["Offset of field: tttset::TerminalInputSpeed"]
        [::std::mem::offset_of!(tttset, TerminalInputSpeed) - 10144usize];
    ["Offset of field: tttset::TerminalOutputSpeed"]
        [::std::mem::offset_of!(tttset, TerminalOutputSpeed) - 10148usize];
    ["Offset of field: tttset::reserve_DialogFontName"]
        [::std::mem::offset_of!(tttset, reserve_DialogFontName) - 10152usize];
    ["Offset of field: tttset::DialogFontPoint"]
        [::std::mem::offset_of!(tttset, DialogFontPoint) - 10184usize];
    ["Offset of field: tttset::DialogFontCharSet"]
        [::std::mem::offset_of!(tttset, DialogFontCharSet) - 10188usize];
    ["Offset of field: tttset::ConfigVersion"]
        [::std::mem::offset_of!(tttset, ConfigVersion) - 10192usize];
    ["Offset of field: tttset::RunningVersion"]
        [::std::mem::offset_of!(tttset, RunningVersion) - 10196usize];
    ["Offset of field: tttset::SelectStartDelay"]
        [::std::mem::offset_of!(tttset, SelectStartDelay) - 10200usize];
    ["Offset of field: tttset::UnicodeAmbiguousWidth"]
        [::std::mem::offset_of!(tttset, UnicodeAmbiguousWidth) - 10204usize];
    ["Offset of field: tttset::UnicodeEmojiOverride"]
        [::std::mem::offset_of!(tttset, UnicodeEmojiOverride) - 10205usize];
    ["Offset of field: tttset::UnicodeEmojiWidth"]
        [::std::mem::offset_of!(tttset, UnicodeEmojiWidth) - 10206usize];
    ["Offset of field: tttset::HomeDirW"][::std::mem::offset_of!(tttset, HomeDirW) - 10208usize];
    ["Offset of field: tttset::SetupFNameW"]
        [::std::mem::offset_of!(tttset, SetupFNameW) - 10216usize];
    ["Offset of field: tttset::KeyCnfFNW"][::std::mem::offset_of!(tttset, KeyCnfFNW) - 10224usize];
    ["Offset of field: tttset::LogFNW"][::std::mem::offset_of!(tttset, LogFNW) - 10232usize];
    ["Offset of field: tttset::MacroFNW"][::std::mem::offset_of!(tttset, MacroFNW) - 10240usize];
    ["Offset of field: tttset::UILanguageFileW"]
        [::std::mem::offset_of!(tttset, UILanguageFileW) - 10248usize];
    ["Offset of field: tttset::reserve_UILanguageFileW_ini"]
        [::std::mem::offset_of!(tttset, reserve_UILanguageFileW_ini) - 10256usize];
    ["Offset of field: tttset::ExeDirW"][::std::mem::offset_of!(tttset, ExeDirW) - 10264usize];
    ["Offset of field: tttset::LogDirW"][::std::mem::offset_of!(tttset, LogDirW) - 10272usize];
    ["Offset of field: tttset::FileDirW"][::std::mem::offset_of!(tttset, FileDirW) - 10280usize];
    ["Offset of field: tttset::LogDefaultPathW"]
        [::std::mem::offset_of!(tttset, LogDefaultPathW) - 10288usize];
    ["Offset of field: tttset::PluginVTIconInstance"]
        [::std::mem::offset_of!(tttset, PluginVTIconInstance) - 10296usize];
    ["Offset of field: tttset::PluginVTIconID"]
        [::std::mem::offset_of!(tttset, PluginVTIconID) - 10304usize];
    ["Offset of field: tttset::TeraTermInstance"]
        [::std::mem::offset_of!(tttset, TeraTermInstance) - 10312usize];
    ["Offset of field: tttset::WindowCornerDontround"]
        [::std::mem::offset_of!(tttset, WindowCornerDontround) - 10320usize];
    ["Offset of field: tttset::DialogFontNameW"]
        [::std::mem::offset_of!(tttset, DialogFontNameW) - 10322usize];
    ["Offset of field: tttset::NotifySound"]
        [::std::mem::offset_of!(tttset, NotifySound) - 10388usize];
    ["Offset of field: tttset::LogDefaultNameW"]
        [::std::mem::offset_of!(tttset, LogDefaultNameW) - 10392usize];
    ["Offset of field: tttset::Dec2Unicode"]
        [::std::mem::offset_of!(tttset, Dec2Unicode) - 10400usize];
    ["Offset of field: tttset::DelimListW"]
        [::std::mem::offset_of!(tttset, DelimListW) - 10408usize];
    ["Offset of field: tttset::IniAutoBackup"]
        [::std::mem::offset_of!(tttset, IniAutoBackup) - 10416usize];
    ["Offset of field: tttset::BracketedSupport"]
        [::std::mem::offset_of!(tttset, BracketedSupport) - 10418usize];
    ["Offset of field: tttset::BracketedControlOnly"]
        [::std::mem::offset_of!(tttset, BracketedControlOnly) - 10420usize];
    ["Offset of field: tttset::ViewlogEditorW"]
        [::std::mem::offset_of!(tttset, ViewlogEditorW) - 10424usize];
    ["Offset of field: tttset::ViewlogEditorArg"]
        [::std::mem::offset_of!(tttset, ViewlogEditorArg) - 10432usize];
    ["Offset of field: tttset::BeepVBellWait"]
        [::std::mem::offset_of!(tttset, BeepVBellWait) - 10440usize];
    ["Offset of field: tttset::SendfileDelayType"]
        [::std::mem::offset_of!(tttset, SendfileDelayType) - 10444usize];
    ["Offset of field: tttset::SendfileDelayTick"]
        [::std::mem::offset_of!(tttset, SendfileDelayTick) - 10446usize];
    ["Offset of field: tttset::SendfileSize"]
        [::std::mem::offset_of!(tttset, SendfileSize) - 10448usize];
    ["Offset of field: tttset::SendfileSequential"]
        [::std::mem::offset_of!(tttset, SendfileSequential) - 10452usize];
    ["Offset of field: tttset::SendfileSkipOptionDialog"]
        [::std::mem::offset_of!(tttset, SendfileSkipOptionDialog) - 10454usize];
    ["Offset of field: tttset::ExperimentalTreePropertySheetEnable"]
        [::std::mem::offset_of!(tttset, ExperimentalTreePropertySheetEnable) - 10456usize];
};
#[doc = "\tTTTSet\n\t\t�Z�b�V�����\u{315}�����\n\t\t���\u{30d}\\���\u{302}\u{355}�����ɃR�s�[�����\n\t\tpath���A���I�Ɋm�ۂ��������\u{303}R�s�[��\n\t\t../ttcmn_dup.cpp ���Q��"]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of TComVar"][::std::mem::size_of::<TComVar>() - 34248usize];
    ...
    ["Offset of field: TComVar::Ready"][::std::mem::offset_of!(TComVar, Ready) - 17432usize];
    ["Offset of field: TComVar::Open"][::std::mem::offset_of!(TComVar, Open) - 17436usize];
    ["Offset of field: TComVar::PortType"][::std::mem::offset_of!(TComVar, PortType) - 17440usize];
    ["Offset of field: TComVar::ComPort"][::std::mem::offset_of!(TComVar, ComPort) - 17442usize];
    ["Offset of field: TComVar::s"][::std::mem::offset_of!(TComVar, s) - 17448usize];
    ["Offset of field: TComVar::RetryCount"]
        [::std::mem::offset_of!(TComVar, RetryCount) - 17456usize];
    ["Offset of field: TComVar::ComID"][::std::mem::offset_of!(TComVar, ComID) - 17464usize];
    ["Offset of field: TComVar::CanSend"][::std::mem::offset_of!(TComVar, CanSend) - 17472usize];
    ["Offset of field: TComVar::RRQ"][::std::mem::offset_of!(TComVar, RRQ) - 17476usize];
    ["Offset of field: TComVar::reserve_SendKanjiFlag"]
        [::std::mem::offset_of!(TComVar, reserve_SendKanjiFlag) - 17480usize];
    ["Offset of field: TComVar::reserve_EchoKanjiFlag"]
        [::std::mem::offset_of!(TComVar, reserve_EchoKanjiFlag) - 17484usize];
    ["Offset of field: TComVar::reserve_SendCode"]
        [::std::mem::offset_of!(TComVar, reserve_SendCode) - 17488usize];
    ["Offset of field: TComVar::reserve_EchoCode"]
        [::std::mem::offset_of!(TComVar, reserve_EchoCode) - 17492usize];
    ["Offset of field: TComVar::reserve_SendKanjiFirst"]
        [::std::mem::offset_of!(TComVar, reserve_SendKanjiFirst) - 17496usize];
    ["Offset of field: TComVar::reserve_EchoKanjiFirst"]
        [::std::mem::offset_of!(TComVar, reserve_EchoKanjiFirst) - 17497usize];
    ["Offset of field: TComVar::reserve_Language"]
        [::std::mem::offset_of!(TComVar, reserve_Language) - 17498usize];
    ["Offset of field: TComVar::CRSend"][::std::mem::offset_of!(TComVar, CRSend) - 17500usize];
    ["Offset of field: TComVar::KanjiCodeEcho"]
        [::std::mem::offset_of!(TComVar, KanjiCodeEcho) - 17502usize];
    ["Offset of field: TComVar::reserve_JIS7KatakanaEcho"]
        [::std::mem::offset_of!(TComVar, reserve_JIS7KatakanaEcho) - 17504usize];
    ["Offset of field: TComVar::KanjiCodeSend"]
        [::std::mem::offset_of!(TComVar, KanjiCodeSend) - 17506usize];
    ["Offset of field: TComVar::reserve_JIS7KatakanaSend"]
        [::std::mem::offset_of!(TComVar, reserve_JIS7KatakanaSend) - 17508usize];
    ["Offset of field: TComVar::reserve_KanjiIn"]
        [::std::mem::offset_of!(TComVar, reserve_KanjiIn) - 17510usize];
    ["Offset of field: TComVar::reserve_KanjiOut"]
        [::std::mem::offset_of!(TComVar, reserve_KanjiOut) - 17512usize];
    ["Offset of field: TComVar::reserve_RussHost"]
        [::std::mem::offset_of!(TComVar, reserve_RussHost) - 17514usize];
    ["Offset of field: TComVar::reserve_RussClient"]
        [::std::mem::offset_of!(TComVar, reserve_RussClient) - 17516usize];
    ["Offset of field: TComVar::DelayPerChar"]
        [::std::mem::offset_of!(TComVar, DelayPerChar) - 17518usize];
    ["Offset of field: TComVar::DelayPerLine"]
        [::std::mem::offset_of!(TComVar, DelayPerLine) - 17520usize];
    ["Offset of field: TComVar::TelBinRecv"]
        [::std::mem::offset_of!(TComVar, TelBinRecv) - 17524usize];
    ["Offset of field: TComVar::TelBinSend"]
        [::std::mem::offset_of!(TComVar, TelBinSend) - 17528usize];
    ["Offset of field: TComVar::DelayFlag"]
        [::std::mem::offset_of!(TComVar, DelayFlag) - 17532usize];
    ["Offset of field: TComVar::TelFlag"][::std::mem::offset_of!(TComVar, TelFlag) - 17536usize];
    ["Offset of field: TComVar::TelMode"][::std::mem::offset_of!(TComVar, TelMode) - 17540usize];
    ["Offset of field: TComVar::IACFlag"][::std::mem::offset_of!(TComVar, IACFlag) - 17544usize];
    ["Offset of field: TComVar::TelCRFlag"]
        [::std::mem::offset_of!(TComVar, TelCRFlag) - 17548usize];
    ["Offset of field: TComVar::TelCRSend"]
        [::std::mem::offset_of!(TComVar, TelCRSend) - 17552usize];
    ["Offset of field: TComVar::TelCRSendEcho"]
        [::std::mem::offset_of!(TComVar, TelCRSendEcho) - 17556usize];
    ["Offset of field: TComVar::TelAutoDetect"]
        [::std::mem::offset_of!(TComVar, TelAutoDetect) - 17560usize];
    ["Offset of field: TComVar::reserve_2"]
        [::std::mem::offset_of!(TComVar, reserve_2) - 17568usize];
    ["Offset of field: TComVar::reserve_4"]
        [::std::mem::offset_of!(TComVar, reserve_4) - 17576usize];
    ["Offset of field: TComVar::reserve_5"]
        [::std::mem::offset_of!(TComVar, reserve_5) - 17584usize];
    ["Offset of field: TComVar::reserve_3"]
        [::std::mem::offset_of!(TComVar, reserve_3) - 17600usize];
    ["Offset of field: TComVar::reserve_6"]
        [::std::mem::offset_of!(TComVar, reserve_6) - 17608usize];
    ["Offset of field: TComVar::reserve_7"]
        [::std::mem::offset_of!(TComVar, reserve_7) - 17616usize];
    ["Offset of field: TComVar::reserve_1"]
        [::std::mem::offset_of!(TComVar, reserve_1) - 17628usize];
    ["Offset of field: TComVar::reserve_8"]
        [::std::mem::offset_of!(TComVar, reserve_8) - 17636usize];
    ["Offset of field: TComVar::reserve_9"]
        [::std::mem::offset_of!(TComVar, reserve_9) - 17640usize];
    ["Offset of field: TComVar::reserve_10"]
        [::std::mem::offset_of!(TComVar, reserve_10) - 17644usize];
    ["Offset of field: TComVar::NoMsg"][::std::mem::offset_of!(TComVar, NoMsg) - 17648usize];
    ["Offset of field: TComVar::RetryWithOtherProtocol"]
        [::std::mem::offset_of!(TComVar, RetryWithOtherProtocol) - 17652usize];
    ["Offset of field: TComVar::res0"][::std::mem::offset_of!(TComVar, res0) - 17656usize];
    ["Offset of field: TComVar::res"][::std::mem::offset_of!(TComVar, res) - 17664usize];
    ["Offset of field: TComVar::reserve_11"]
        [::std::mem::offset_of!(TComVar, reserve_11) - 17672usize];
    ["Offset of field: TComVar::reserve_CodePage"]
        [::std::mem::offset_of!(TComVar, reserve_CodePage) - 17680usize];
    ["Offset of field: TComVar::ConnetingTimeout"]
        [::std::mem::offset_of!(TComVar, ConnetingTimeout) - 17688usize];
    ["Offset of field: TComVar::LastSendTime"]
        [::std::mem::offset_of!(TComVar, LastSendTime) - 17696usize];
    ["Offset of field: TComVar::isSSH"][::std::mem::offset_of!(TComVar, isSSH) - 17704usize];
    ["Offset of field: TComVar::reserve_TitleRemote"]
        [::std::mem::offset_of!(TComVar, reserve_TitleRemote) - 17706usize];
    ["Offset of field: TComVar::LineModeBuff"]
        [::std::mem::offset_of!(TComVar, LineModeBuff) - 17756usize];
    ["Offset of field: TComVar::LineModeBuffCount"]
        [::std::mem::offset_of!(TComVar, LineModeBuffCount) - 34140usize];
    ["Offset of field: TComVar::FlushLen"][::std::mem::offset_of!(TComVar, FlushLen) - 34144usize];
    ["Offset of field: TComVar::Flush"][::std::mem::offset_of!(TComVar, Flush) - 34148usize];
    ["Offset of field: TComVar::TelLineMode"]
        [::std::mem::offset_of!(TComVar, TelLineMode) - 34152usize];
    ["Offset of field: TComVar::reserve_12"]
        [::std::mem::offset_of!(TComVar, reserve_12) - 34160usize];
    ["Offset of field: TComVar::reserve_13"]
        [::std::mem::offset_of!(TComVar, reserve_13) - 34168usize];
    ["Offset of field: TComVar::NotifyIcon"]
        [::std::mem::offset_of!(TComVar, NotifyIcon) - 34176usize];
    ["Offset of field: TComVar::ConnectedTime"]
        [::std::mem::offset_of!(TComVar, ConnectedTime) - 34184usize];
    ["Offset of field: TComVar::Log1Byte"][::std::mem::offset_of!(TComVar, Log1Byte) - 34192usize];
    ["Offset of field: TComVar::Log1Bin"][::std::mem::offset_of!(TComVar, Log1Bin) - 34200usize];
    ["Offset of field: TComVar::LogBinSkip"]
        [::std::mem::offset_of!(TComVar, LogBinSkip) - 34208usize];
    ["Offset of field: TComVar::ts"][::std::mem::offset_of!(TComVar, ts) - 34216usize];
    ["Offset of field: TComVar::TitleRemoteW"]
        [::std::mem::offset_of!(TComVar, TitleRemoteW) - 34224usize];
    ["Offset of field: TComVar::StateSend"]
        [::std::mem::offset_of!(TComVar, StateSend) - 34232usize];
    ["Offset of field: TComVar::StateEcho"]
        [::std::mem::offset_of!(TComVar, StateEcho) - 34240usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of TGetHNRec"][::std::mem::size_of::<TGetHNRec>() - 48usize];
    ["Alignment of TGetHNRec"][::std::mem::align_of::<TGetHNRec>() - 8usize];
    ["Offset of field: TGetHNRec::SetupFN"][::std::mem::offset_of!(TGetHNRec, SetupFN) - 0usize];
    ["Offset of field: TGetHNRec::SetupFNW"][::std::mem::offset_of!(TGetHNRec, SetupFNW) - 8usize];
    ["Offset of field: TGetHNRec::PortType"][::std::mem::offset_of!(TGetHNRec, PortType) - 16usize];
    ["Offset of field: TGetHNRec::HostName"][::std::mem::offset_of!(TGetHNRec, HostName) - 24usize];
    ["Offset of field: TGetHNRec::Telnet"][::std::mem::offset_of!(TGetHNRec, Telnet) - 32usize];
    ["Offset of field: TGetHNRec::TelPort"][::std::mem::offset_of!(TGetHNRec, TelPort) - 34usize];
    ["Offset of field: TGetHNRec::TCPPort"][::std::mem::offset_of!(TGetHNRec, TCPPort) - 36usize];
    ["Offset of field: TGetHNRec::ProtocolFamily"]
        [::std::mem::offset_of!(TGetHNRec, ProtocolFamily) - 38usize];
    ["Offset of field: TGetHNRec::ComPort"][::std::mem::offset_of!(TGetHNRec, ComPort) - 40usize];
    ["Offset of field: TGetHNRec::MaxComPort"]
        [::std::mem::offset_of!(TGetHNRec, MaxComPort) - 42usize];
};
pub type PGetHNRec = *mut TGetHNRec;
pub type PSetupTerminal =
    ::std::option::Option<unsafe extern "C" fn(WndParent: HWND, ts: PTTSet) -> BOOL>;
pub type PSetupWin =
    ::std::option::Option<unsafe extern "C" fn(WndParent: HWND, ts: PTTSet) -> BOOL>;
...
pub type PGetHostName =
    ::std::option::Option<unsafe extern "C" fn(WndParent: HWND, GetHNRec: PGetHNRec) -> BOOL>;
pub type PChangeDirectory =
    ::std::option::Option<unsafe extern "C" fn(WndParent: HWND, ts: PTTSet) -> BOOL>;
pub type PAboutDialog = ::std::option::Option<unsafe extern "C" fn(WndParent: HWND) -> BOOL>;
pub type PChooseFontDlg = ::std::option::Option<
    unsafe extern "C" fn(WndParent: HWND, LogFont: LPLOGFONT, ts: PTTSet) -> BOOL,
>;
pub type PSetupGeneral =
    ::std::option::Option<unsafe extern "C" fn(WndParent: HWND, ts: PTTSet) -> BOOL>;
pub type PWindowWindow =
    ::std::option::Option<unsafe extern "C" fn(WndParent: HWND, Close: PBOOL) -> BOOL>;
...
>;
pub type Thtonl = ::std::option::Option<unsafe extern "C" fn(hostlong: u_long) -> u_long>;
pub type Thtons = ::std::option::Option<unsafe extern "C" fn(hostshort: u_short) -> u_short>;
pub type Tinet_addr = ::std::option::Option<
    unsafe extern "C" fn(cp: *const ::std::os::raw::c_char) -> ::std::os::raw::c_ulong,
>;
...
>;
pub type TWSACancelAsyncRequest =
    ::std::option::Option<unsafe extern "C" fn(hAsyncTaskHandle: HANDLE) -> ::std::os::raw::c_int>;
pub type TWSAGetLastError = ::std::option::Option<unsafe extern "C" fn() -> ::std::os::raw::c_int>;
...
>;
pub type Tfreeaddrinfo = ::std::option::Option<unsafe extern "C" fn(ai: *mut addrinfo)>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type PReadIniFile =
    ::std::option::Option<unsafe extern "C" fn(FName: *const wchar_t, ts: PTTSet)>;
pub type PWriteIniFile =
    ::std::option::Option<unsafe extern "C" fn(FName: *const wchar_t, ts: PTTSet)>;
pub type PReadKeyboardCnf = ::std::option::Option<
    unsafe extern "C" fn(FName: *const wchar_t, KeyMap: PKeyMap, ShowWarning: BOOL),
>;
pub type PCopyHostList =
    ::std::option::Option<unsafe extern "C" fn(IniSrc: *const wchar_t, IniDest: *const wchar_t)>;
pub type PAddHostToList =
    ::std::option::Option<unsafe extern "C" fn(FName: *const wchar_t, Host: *const wchar_t)>;
pub type PParseParam =
    ::std::option::Option<unsafe extern "C" fn(Param: *mut wchar_t, ts: PTTSet, DDETopic: PCHAR)>;
...
>;
pub type TCloseFile = ::std::option::Option<unsafe extern "C" fn(FHandle: HANDLE) -> BOOL>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of TTXSockHooks"][::std::mem::size_of::<TTXSockHooks>() - 136usize];
    ["Alignment of TTXSockHooks"][::std::mem::align_of::<TTXSockHooks>() - 8usize];
    ...
    ["Offset of field: TTXSockHooks::Pconnect"]
        [::std::mem::offset_of!(TTXSockHooks, Pconnect) - 8usize];
    ["Offset of field: TTXSockHooks::Phtonl"]
        [::std::mem::offset_of!(TTXSockHooks, Phtonl) - 16usize];
    ["Offset of field: TTXSockHooks::Phtons"]
        [::std::mem::offset_of!(TTXSockHooks, Phtons) - 24usize];
    ["Offset of field: TTXSockHooks::Pinet_addr"]
        [::std::mem::offset_of!(TTXSockHooks, Pinet_addr) - 32usize];
    ["Offset of field: TTXSockHooks::Pioctlsocket"]
        [::std::mem::offset_of!(TTXSockHooks, Pioctlsocket) - 40usize];
    ["Offset of field: TTXSockHooks::Precv"][::std::mem::offset_of!(TTXSockHooks, Precv) - 48usize];
    ["Offset of field: TTXSockHooks::Pselect"]
        [::std::mem::offset_of!(TTXSockHooks, Pselect) - 56usize];
    ["Offset of field: TTXSockHooks::Psend"][::std::mem::offset_of!(TTXSockHooks, Psend) - 64usize];
    ["Offset of field: TTXSockHooks::Psetsockopt"]
        [::std::mem::offset_of!(TTXSockHooks, Psetsockopt) - 72usize];
    ["Offset of field: TTXSockHooks::Psocket"]
        [::std::mem::offset_of!(TTXSockHooks, Psocket) - 80usize];
    ["Offset of field: TTXSockHooks::PWSAAsyncSelect"]
        [::std::mem::offset_of!(TTXSockHooks, PWSAAsyncSelect) - 88usize];
    ["Offset of field: TTXSockHooks::PWSAAsyncGetHostByName"]
        [::std::mem::offset_of!(TTXSockHooks, PWSAAsyncGetHostByName) - 96usize];
    ["Offset of field: TTXSockHooks::PWSACancelAsyncRequest"]
        [::std::mem::offset_of!(TTXSockHooks, PWSACancelAsyncRequest) - 104usize];
    ["Offset of field: TTXSockHooks::PWSAGetLastError"]
        [::std::mem::offset_of!(TTXSockHooks, PWSAGetLastError) - 112usize];
    ["Offset of field: TTXSockHooks::Pfreeaddrinfo"]
        [::std::mem::offset_of!(TTXSockHooks, Pfreeaddrinfo) - 120usize];
    ["Offset of field: TTXSockHooks::PWSAAsyncGetAddrInfo"]
        [::std::mem::offset_of!(TTXSockHooks, PWSAAsyncGetAddrInfo) - 128usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of TTXFileHooks"][::std::mem::size_of::<TTXFileHooks>() - 32usize];
    ["Alignment of TTXFileHooks"][::std::mem::align_of::<TTXFileHooks>() - 8usize];
    ...
    ["Offset of field: TTXFileHooks::PCloseFile"]
        [::std::mem::offset_of!(TTXFileHooks, PCloseFile) - 8usize];
    ["Offset of field: TTXFileHooks::PReadFile"]
        [::std::mem::offset_of!(TTXFileHooks, PReadFile) - 16usize];
    ["Offset of field: TTXFileHooks::PWriteFile"]
        [::std::mem::offset_of!(TTXFileHooks, PWriteFile) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of TTXSetupHooks"][::std::mem::size_of::<TTXSetupHooks>() - 48usize];
    ["Alignment of TTXSetupHooks"][::std::mem::align_of::<TTXSetupHooks>() - 8usize];
    ...
    ["Offset of field: TTXSetupHooks::WriteIniFile"]
        [::std::mem::offset_of!(TTXSetupHooks, WriteIniFile) - 8usize];
    ["Offset of field: TTXSetupHooks::ReadKeyboardCnf"]
        [::std::mem::offset_of!(TTXSetupHooks, ReadKeyboardCnf) - 16usize];
    ["Offset of field: TTXSetupHooks::CopyHostList"]
        [::std::mem::offset_of!(TTXSetupHooks, CopyHostList) - 24usize];
    ["Offset of field: TTXSetupHooks::AddHostToList"]
        [::std::mem::offset_of!(TTXSetupHooks, AddHostToList) - 32usize];
    ["Offset of field: TTXSetupHooks::ParseParam"]
        [::std::mem::offset_of!(TTXSetupHooks, ParseParam) - 40usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of TTXUIHooks"][::std::mem::size_of::<TTXUIHooks>() - 88usize];
    ["Alignment of TTXUIHooks"][::std::mem::align_of::<TTXUIHooks>() - 8usize];
    ...
    ["Offset of field: TTXUIHooks::SetupWin"]
        [::std::mem::offset_of!(TTXUIHooks, SetupWin) - 8usize];
    ["Offset of field: TTXUIHooks::SetupKeyboard"]
        [::std::mem::offset_of!(TTXUIHooks, SetupKeyboard) - 16usize];
    ["Offset of field: TTXUIHooks::SetupSerialPort"]
        [::std::mem::offset_of!(TTXUIHooks, SetupSerialPort) - 24usize];
    ["Offset of field: TTXUIHooks::SetupTCPIP"]
        [::std::mem::offset_of!(TTXUIHooks, SetupTCPIP) - 32usize];
    ["Offset of field: TTXUIHooks::GetHostName"]
        [::std::mem::offset_of!(TTXUIHooks, GetHostName) - 40usize];
    ["Offset of field: TTXUIHooks::ChangeDirectory"]
        [::std::mem::offset_of!(TTXUIHooks, ChangeDirectory) - 48usize];
    ["Offset of field: TTXUIHooks::AboutDialog"]
        [::std::mem::offset_of!(TTXUIHooks, AboutDialog) - 56usize];
    ["Offset of field: TTXUIHooks::ChooseFontDlg"]
        [::std::mem::offset_of!(TTXUIHooks, ChooseFontDlg) - 64usize];
    ["Offset of field: TTXUIHooks::SetupGeneral"]
        [::std::mem::offset_of!(TTXUIHooks, SetupGeneral) - 72usize];
    ["Offset of field: TTXUIHooks::WindowWindow"]
        [::std::mem::offset_of!(TTXUIHooks, WindowWindow) - 80usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct TTXExports {
    ...
    pub TTXInit: ::std::option::Option<unsafe extern "C" fn(ts: PTTSet, cv: PComVar)>,
    pub TTXGetUIHooks: ::std::option::Option<unsafe extern "C" fn(UIHooks: *mut TTXUIHooks)>,
    pub TTXGetSetupHooks:
        ::std::option::Option<unsafe extern "C" fn(setupHooks: *mut TTXSetupHooks)>,
    pub TTXOpenTCP: ::std::option::Option<unsafe extern "C" fn(hooks: *mut TTXSockHooks)>,
    pub TTXCloseTCP: ::std::option::Option<unsafe extern "C" fn(hooks: *mut TTXSockHooks)>,
    pub TTXSetWinSize: ::std::option::Option<
        unsafe extern "C" fn(rows: ::std::os::raw::c_int, cols: ::std::os::raw::c_int),
    >,
    pub TTXModifyMenu: ::std::option::Option<unsafe extern "C" fn(menu: HMENU)>,
    pub TTXModifyPopupMenu: ::std::option::Option<unsafe extern "C" fn(menu: HMENU)>,
    pub TTXProcessCommand:
        ::std::option::Option<unsafe extern "C" fn(hWin: HWND, cmd: WORD) -> ::std::os::raw::c_int>,
    pub TTXEnd: ::std::option::Option<unsafe extern "C" fn()>,
    pub TTXSetCommandLine: ::std::option::Option<
        unsafe extern "C" fn(cmd: *mut wchar_t, cmdlen: ::std::os::raw::c_int, rec: PGetHNRec),
    >,
    pub TTXOpenFile: ::std::option::Option<unsafe extern "C" fn(hooks: *mut TTXFileHooks)>,
    pub TTXCloseFile: ::std::option::Option<unsafe extern "C" fn(hooks: *mut TTXFileHooks)>,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of TTXExports"][::std::mem::size_of::<TTXExports>() - 112usize];
    ["Alignment of TTXExports"][::std::mem::align_of::<TTXExports>() - 8usize];
    ...
    ["Offset of field: TTXExports::TTXGetUIHooks"]
        [::std::mem::offset_of!(TTXExports, TTXGetUIHooks) - 16usize];
    ["Offset of field: TTXExports::TTXGetSetupHooks"]
        [::std::mem::offset_of!(TTXExports, TTXGetSetupHooks) - 24usize];
    ["Offset of field: TTXExports::TTXOpenTCP"]
        [::std::mem::offset_of!(TTXExports, TTXOpenTCP) - 32usize];
    ["Offset of field: TTXExports::TTXCloseTCP"]
        [::std::mem::offset_of!(TTXExports, TTXCloseTCP) - 40usize];
    ["Offset of field: TTXExports::TTXSetWinSize"]
        [::std::mem::offset_of!(TTXExports, TTXSetWinSize) - 48usize];
    ["Offset of field: TTXExports::TTXModifyMenu"]
        [::std::mem::offset_of!(TTXExports, TTXModifyMenu) - 56usize];
    ["Offset of field: TTXExports::TTXModifyPopupMenu"]
        [::std::mem::offset_of!(TTXExports, TTXModifyPopupMenu) - 64usize];
    ["Offset of field: TTXExports::TTXProcessCommand"]
        [::std::mem::offset_of!(TTXExports, TTXProcessCommand) - 72usize];
    ["Offset of field: TTXExports::TTXEnd"][::std::mem::offset_of!(TTXExports, TTXEnd) - 80usize];
    ["Offset of field: TTXExports::TTXSetCommandLine"]
        [::std::mem::offset_of!(TTXExports, TTXSetCommandLine) - 88usize];
    ["Offset of field: TTXExports::TTXOpenFile"]
        [::std::mem::offset_of!(TTXExports, TTXOpenFile) - 96usize];
    ["Offset of field: TTXExports::TTXCloseFile"]
        [::std::mem::offset_of!(TTXExports, TTXCloseFile) - 104usize];
};
pub type TTXBindProc =
    ::std::option::Option<unsafe extern "C" fn(Version: WORD, exports: *mut TTXExports) -> BOOL>;
